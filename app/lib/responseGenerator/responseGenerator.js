function responseGenerator() {
			...
			for (var sectionListIndex = 0; sectionListIndex < sectionList.length; sectionListIndex++) {
				...
				for (var questionIndex = 0; questionIndex < questionList.length; questionIndex++) {
					...
					if (questionList[questionIndex].isAQuestion == true && censusDate === "") {
						if (questionList[questionIndex].alcrmQuestionID == "I_CENSUS_DATE") {
	...
	self.buildAssessmentResponse = function(sectionList, crossingID, detailID, assNotes) {
		...
		var xmlRequest = "<ass:CreateAssessmentRequest>" + "<ass:assessment>" + "<ass1:crossingID>" + crossingID + "</ass1:crossingID>" + "<ass1:notes>" + Alloy.Globals.Util.escapeXML(assNotes) + "</ass1:notes>";
		//"<ass1:detailId>" + detailID + "</ass1:detailId>" + dateNode +
		riskData + "</ass:assessment>" + "</ass:CreateAssessmentRequest>";
