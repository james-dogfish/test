...
var SudsClient = function(_options) {
	...
	function invokeService(_soapAction, _body, _callback, _failure, _header) {
		...
		// Need to turn off to disable cert validation as NR env goes crazy!
		xhr.onload = function() {
		...
		xhr.onerror = function(e) {
			...
			try {
				...
				Alloy.Globals.Util.convertJson(Ti.XML.serializeToString(xmlDomFromString(this.responseText)), function(data) {
					// callback
					var error_object = JSON.parse(data);
					var error_code = null;
					var error_message = null;
					var error_stacktrace = null;
					if ( typeof error_object !== "undefined" || typeof error_object.response.Envelope.Body !== "undefined" || typeof error_object.response.Envelope.Body.Fault !== "undefined" || typeof error_object.response.Envelope.Body.Fault.faultcode !== "undefined" || typeof error_object.response.Envelope.Body.Fault.faultstring !== "undefined") {
						...
						if ( typeof error_object.response.Envelope.Body.Fault.faultstring !== "undefined") {
							...
							if ( typeof error_object.response.Envelope.Body.Fault.detail !== "undefined" && typeof error_object.response.Envelope.Body.Fault.detail.ADDITIONAL_DETAIL !== "undefined") {
