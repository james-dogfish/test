// File is used to return string that matches a regex 
// used for error validation in questionRenderer.js
// validateSingleQuestionValue

var ret = require('tools/ret/index');
var types = ret.types;
